...
export data_path=/scratch/spp9399/MIA-DPO/gen_data/gen_instruction/pip_test_images.json
export output_file=/scratch/spp9399/MIA-DPO/inference_outputs/pip_all_attn_ratios.json
